...
const FEATURES = [
  "Question bank upload facility",
  "Ready made question banks available",
...
export default function SubscriptionPlans({
  ...
  return (
    <div>
      {showHero && <PageHero title="Exam Price" />}
          ...
          {PLANS.map((p, i) => (
            ...
            >
              ...
              <motion.button
                ...
                whileHover={{
                  y: -2,
                  boxShadow: "0 12px 24px rgba(63,145,66,0.35)",
                }}
                whileTap={{ scale: 0.96 }}
              >
                Pay Now
